...
public class Foreign_Ticket_SearchTest {
...
public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath("(//a[.='Admin'])[1]")).click();
		 driver.findElement(By.id("username")).sendKeys(user);
	       ...
	       driver.findElement(By.linkText("Foreigner Ticket Search")).click();
	       driver.findElement(By.id("searchdata")).sendKeys("simon");
	       driver.findElement(By.xpath("//button[@id='submit']")).click();
	       driver.findElement(By.xpath("//div[@class='data-tables']/table/tbody[2]/tr/td[5]/a")).click();
		...
		//System.out.println("Total ticket price :"+driver.findElement(By.xpath("//table[@class='table table-striped table-bordered first']/tbody/tr[4]/th")).getText());
		System.out.println("Total ticket price :"+driver.findElement(By.xpath("//table[@class='table table-striped table-bordered first']/tbody/tr[4]/td")).getText());
}
}
