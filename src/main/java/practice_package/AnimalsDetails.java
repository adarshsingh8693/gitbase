...
import com.Zoo_View.objectresporatory.AddAnimalPage;
import com.Zoo_View.objectresporatory.LoginPage;
import com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.File;

import io.github.bonigarcia.wdm.WebDriverManager;

public class AnimalsDetails  extends BaseClass {
	...
	public void test() throws IOException {	
		...
		System.out.println(Url+" "+Browser+" "+User+" "+Password);
		 ...
		 FileInputStream fi=new FileInputStream("./src/test/resources/TestData.xlsx");
	       ...
	       //System.out.println(sheet.getRow(3).getCell(1).toString());
//	    		  String data = sheet.getRow(1).getCell(0 ).getStringCellValue();
//	       System.out.println(data);*/
	       
	      
			
			String anName=fl.getExcelData("create",1,1);
			//String absPath=fl.getExcelData("create",2,1);
			String cNo=fl.getExcelData("create",2,1);
			String fNo=fl.getExcelData("create",3,1);
			String brd=fl.getExcelData("create",4,1);
			String mssg=fl.getExcelData("create",5,1);
	      // driver.manage().window().maximize();
	       ...
	       //Thread.sleep(1000);
	       AddAnimalPage aa=new AddAnimalPage(driver);
	       java.io.File f=new java.io.File("./src/test/resources/Screenshot (1).png");
	       String absPath=f.getAbsolutePath();
	       aa.logInPage(anName, absPath, cNo, fNo, brd, mssg);
	      ...
	      // java.io.File f=new java.io.File("./src/test/resources/Screenshot (1).png");
	       ...
	       //Thread.sleep(9000);
	        String text = wdu.acceptAlert(driver);
